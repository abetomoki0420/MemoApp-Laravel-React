...
function AppHeader(props) {
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'div',
      { className: 'create-btn-area' },
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { type: 'button', value: '\u65B0\u898F\u4F5C\u6210', onClick: props.changeToCreateMode })
    )
  );
};
...
function Memo(props) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    'div',
    { className: 'prev-memo', 'data-id': props.memo_data.id, onClick: props.showMemo },
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'div',
      { className: 'overview' },
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        'from:',
        props.memo_data.created_at
      ),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        { className: 'updated_date' },
        'last:',
        props.memo_data.updated_at
      )
    )
  );
}
...
function Memos(props) {
  var memos = props.memo_datas.map(function (memo_data, index) {
    // console.log(index);
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Memo, {
      memo_data: memo_data,
      key: index,
...
function LeftSideBar(props) {
  var prevMark = [];
  if (props.app_mode !== "prev" && props.app_mode !== "search_prev") {
    prevMark.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'div',
      {
  ...
  switch (props.app_mode) {
    case "prev":
      if (props.memo_datas.length > 0) {
        contents.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Memos, {
        ...
        contents.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'div',
          { className: 'empty-memo' },
          '\u30E1\u30E2\u306F\u3042\u308A\u307E\u305B\u3093'
        ));
      }
      break;
    case "search_prev":
      var search_datas = props.memo_datas.filter(function (memo_data) {
    ...
    case "show":
      contents.push(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'p',
          { className: 'title' },
          props.selectMemo.title
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'p',
          { className: 'content' },
          props.selectMemo.content
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'div',
          { className: 'dates' },
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            { className: 'created_date' },
            'from:',
            props.selectMemo.created_at
          ),
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'p',
            { className: 'updated_date' },
            'last:',
            props.selectMemo.updated_at
          )
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'div',
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'div',
            { className: 'modify', onClick: props.changeToModifyMode },
            '\u4FEE\u6B63'
          ),
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'div',
            { className: 'delete', onClick: props.deleteMemo },
            '\u524A\u9664'
          )
        )
      ));
...
function RightSideBar(props) {
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', { className: 'right-sidebar' });
}

var MemoContent = function (_Component) {
  _inherits(MemoContent, _Component);

  function MemoContent(props) {
    _classCallCheck(this, MemoContent);

    var _this = _possibleConstructorReturn(this, (MemoContent.__proto__ || Object.getPrototypeOf(MemoContent)).call(this, props));
    ...
    //function binding
    _this.getCurrentMemos = _this.getCurrentMemos.bind(_this);
    _this.changeToCreateMode = _this.changeToCreateMode.bind(_this);
    _this.changeToSearchMode = _this.changeToSearchMode.bind(_this);
    _this.inputNewTitle = _this.inputNewTitle.bind(_this);
    _this.inputNewContent = _this.inputNewContent.bind(_this);
    _this.createNewMemo = _this.createNewMemo.bind(_this);
    _this.showMemo = _this.showMemo.bind(_this);
    _this.backToPrev = _this.backToPrev.bind(_this);
    _this.showMemo = _this.showMemo.bind(_this);
    _this.deleteMemo = _this.deleteMemo.bind(_this);
    _this.modifyMemo = _this.modifyMemo.bind(_this);
    _this.changeToModifyMode = _this.changeToModifyMode.bind(_this);
    _this.modifyTitle = _this.modifyTitle.bind(_this);
    _this.modifyContent = _this.modifyContent.bind(_this);
    return _this;
  }
  ...
  _createClass(MemoContent, [{
    key: 'getCurrentMemos',
    value: function getCurrentMemos() {
      var _this2 = this;
      ...
      $.ajax({
        ...
        var memo_datas = JSON.parse(data);
        _this2.setState({
    ...
    key: 'inputNewTitle',
    value: function inputNewTitle(e) {
      this.setState({
    ...
    key: 'inputNewContent',
    value: function inputNewContent(e) {
      this.setState({
    ...
    key: 'modifyContent',
    value: function modifyContent(e) {
      this.setState({
    ...
    key: 'changeToSearchMode',
    value: function changeToSearchMode(e) {
    ...
    key: 'changeToModifyMode',
    value: function changeToModifyMode() {
      this.setState({
    ...
    key: 'showMemo',
    value: function showMemo(e) {
      var id = +e.currentTarget.dataset.id;
      var pos = this.state.memo_datas.map(function (memo_data) {
        return memo_data.id;
      }).indexOf(id);
    ...
    key: 'createNewMemo',
    value: function createNewMemo() {
      var _this3 = this;

      var title = this.state.create_data_title;
      var content = this.state.create_data_content;
    ...
    key: 'modifyMemo',
    value: function modifyMemo() {
      var _this4 = this;

      var id = this.state.modify_data_id;
      var title = this.state.modify_data_title;
      var content = this.state.modify_data_content;
    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(AppHeader, {
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          'div',
          { className: 'app-body' },
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(LeftSideBar, {
            app_mode: this.state.app_mode,
            backToPrev: this.backToPrev
          }),
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(CenterBar, {
            app_mode: this.state.app_mode,
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(RightSideBar, {
            app_mode: this.state.app_mode,
...
/* harmony default export */ __webpack_exports__["default"] = (MemoContent);


if (document.getElementById('content')) {
  __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(MemoContent, null), document.getElementById('content'));
}
